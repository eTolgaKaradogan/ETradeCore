...
namespace AppCore.Business.Bases
{
    ...
    public interface IService<TEntity, TModel> where TEntity : RecordBase, new() where TModel : RecordBase, new() // TEntity ve TModel için sadece RecordBase'den türetilen class'lar yazılabilir
                                                                                                                  // ( Prodcut, Category, ProductModel, CategoryModel)
    {
